...
<body>
	...
	<!-- main title header -->
	<header class="masthead bg-encore_TourSchs_background text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<!-- Masthead Heading -->
			<h1 class="masthead-heading text-uppercase mb-0">TourSch 페이지입니다.</h1>
